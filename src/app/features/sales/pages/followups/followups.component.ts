...
@Component({
 selector: 'app-sales-followups', standalone: true,
...
export class FollowupsPageComponent extends RecordPageController {
 constructor() { super('sales', 'followups', inject(SalesService)); }
}
